...
public class Calculator {
   ...
   public String calc(String a, String operator, String b) {
      ...
      if (Fraction.isFraction(a) && Fraction.isFraction(b)){
         ...
         return calc(FractionA, operator, FractionB).toString();
      }else if (Fraction.isFraction(a)){
         first = parseFraction(a).floatValue();
         second =  Float.parseFloat(b);
      }else if(Fraction.isFraction(b)){
         first =  Float.parseFloat(a);
         second = parseFraction(b).floatValue();
      }else{
         first =  Float.parseFloat(a);
         second =  Float.parseFloat(b);
      }
      return calc(first,operator,second).toString();
   }

   public Float calc(float a, String operator, float b){
      /*
       * differentiate between operators and compute regarding operation.
       */
      float result;
